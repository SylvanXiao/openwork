...
export default {
  ...
  "connectors.add": "添加 MCP",
  "connectors.connecting": "连接中…",
  "connectors.feishu_app_id": "App ID",
  "connectors.feishu_app_secret": "App Secret",
  "connectors.feishu_connect": "连接",
  "connectors.feishu_connect_failed": "连接失败",
  "connectors.feishu_connected": "已连接",
  "connectors.feishu_title": "飞书 / Lark",
  "connectors.my_mcp": "我的 MCP",
  "connectors.no_mcp": "还没有 MCP 服务器",
  "connectors.platform": "平台连接器",
  "connectors.test": "测试连接",
  "connectors.test_idle": "尚未测试",
  "connectors.test_ok": "已连接 · {count} 个工具",
  "connectors.testing": "测试中…",
  "connectors.title": "连接器",
  "connectors.sidebar_title": "连接器",
  "connectors.copy": "复制",
  "connectors.feishu_step2_hint": "上方命令会被注册；登录命令是一次性的浏览器授权步骤。",
  "connectors.feishu_step2_desc": "点击注册，把 MCP 服务器加入此工作区。完成第 1 步后，它将使用你登录的用户账号。",
  "connectors.feishu_step2": "第 2 步：注册 MCP 服务器",
  "connectors.feishu_step1_desc": "在终端运行此命令。它会打开浏览器登录飞书，并在本地保存你的用户凭证。只需做一次（凭证过期时再做）。",
  "connectors.feishu_step1": "第 1 步：浏览器授权",
  "connectors.feishu_register": "注册飞书 MCP",
  "connectors.feishu_needs_auth": "需要用户授权 — 请先在终端运行上面的登录命令",
