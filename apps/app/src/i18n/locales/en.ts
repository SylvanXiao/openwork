...
export default {
  ...
  "connectors.add": "Add MCP",
  "connectors.connecting": "Connecting...",
  "connectors.feishu_app_id": "App ID",
  "connectors.feishu_app_secret": "App Secret",
  "connectors.feishu_connect": "Connect",
  "connectors.feishu_connect_failed": "Connection failed",
  "connectors.feishu_connected": "Connected",
  "connectors.feishu_title": "Feishu / Lark",
  "connectors.my_mcp": "My MCPs",
  "connectors.no_mcp": "No MCP servers yet",
  "connectors.platform": "Platform connectors",
  "connectors.test": "Test",
  "connectors.test_idle": "Not tested yet",
  "connectors.test_ok": "Connected · {count} tools",
  "connectors.testing": "Testing...",
  "connectors.title": "Connectors",
  "connectors.sidebar_title": "Connectors",
  "connectors.copy": "Copy",
  "connectors.feishu_step2_hint": "The MCP command above is the one registered; the login command is a one-time browser auth step.",
  "connectors.feishu_step2_desc": "Click Register to add the MCP server to this workspace. After step 1, it will use your logged-in user account.",
  "connectors.feishu_step2": "Step 2: Register the MCP server",
  "connectors.feishu_step1_desc": "Run this command in a terminal. It opens a browser to log in to Feishu and saves your user token locally. You only need to do this once (or when the token expires).",
  "connectors.feishu_step1": "Step 1: Authorize in your browser",
  "connectors.feishu_register": "Register Feishu MCP",
  "connectors.feishu_needs_auth": "Needs user authorization — run the login command above first",
